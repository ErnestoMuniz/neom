    ...
    <div class="py-12 h-full">
        ...
        <div class="mx-3 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 md:grid md:grid-cols-6 md:gap-2">
                    ...
                    <div class="col-span-3 overflow-x-scroll md:overflow-x-auto">
                        ...
                        <table id='onus' class='striped w-full table-auto mx-auto shadow-md rounded-lg overflow-hidden mt-2'>
                            <thead>
                                <tr class='bg-gray-300 uppercase text-sm'>
