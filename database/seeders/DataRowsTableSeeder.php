...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $oltDataType = DataType::where('slug', 'olts')->firstOrFail();
        ...
        $dataRow = $this->dataRow($oltDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Id',
        ...
        $dataRow = $this->dataRow($oltDataType, 'nome');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Nome',
        ...
        $dataRow = $this->dataRow($oltDataType, 'user');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'User',
        ...
        $dataRow = $this->dataRow($oltDataType, 'slot');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Número de Slots',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($oltDataType, 'vendor');
        if (!$dataRow->exists) {
            $dataRow->fill([
        ...
        $dataRow = $this->dataRow($oltDataType, 'model');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Modelo',
        ...
        $dataRow = $this->dataRow($oltDataType, 'firmware');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($oltDataType, 'last_cpu');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Last CPU',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($oltDataType, 'last_mem');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Last Mem',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($oltDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
        ...
        $dataRow = $this->dataRow($oltDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
