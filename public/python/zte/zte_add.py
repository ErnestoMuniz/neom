...
tn.write(
    f"interface gpon_olt-1/{pos.split('/')[1]}/{pos.split('/')[2]}\n".encode('ascii'))
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
...
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
    f"interface gpon_onu-1/{pos.split('/')[1]}/{pos.split('/')[2]}:{pos.split('/')[3]}\n".encode('ascii'))
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
    f"name {desc}\n".encode('ascii'))
tmp += tn.read_until(b"#").decode('ascii')
...
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
    f"interface vport-1/{pos.split('/')[1]}/{pos.split('/')[2]}.{pos.split('/')[3]}:1\n".encode('ascii'))
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
...
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
    f"pon-onu-mng gpon_onu-1/{pos.split('/')[1]}/{pos.split('/')[2]}:{pos.split('/')[3]}\n".encode('ascii'))
tmp += tn.read_until(b"#").decode('ascii')
tn.write(
