...
class HuaweiController extends Controller
{
    ...
    public static function firmware($id){
        ...
        $output = shell_exec("python python/huawei/huawei_firmware.py $olt->ip:$olt->port $olt->user $olt->pass");
    ...
    public static function cpu($id){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_cpu.py $olt->ip:$olt->port $olt->user $olt->pass");
    ...
    public static function mem($id){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_mem.py $olt->ip:$olt->port $olt->user $olt->pass");
    ...
    public static function pon($id, $cmd){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_count.py $olt->ip:$olt->port $olt->user $olt->pass $cmd");
        echo str_replace("'", '"', $output);
    }

    public static function pending($id){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_pending.py $olt->ip:$olt->port $olt->user $olt->pass");
        echo str_replace("'", '"', $output);
    }

    public static function onu($id, $cmd){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_search.py $olt->ip:$olt->port $olt->user $olt->pass $cmd");
        echo str_replace("'", '"', $output);
    }

    public static function remove($id, $pon, $pos){
        $olt = DB::table('olts')->where('id', $id)->first();
        $output = shell_exec("python python/huawei/huawei_remove.py $olt->ip:$olt->port $olt->user $olt->pass $pon $pos");
        echo str_replace("'", '"', $output);
    }
